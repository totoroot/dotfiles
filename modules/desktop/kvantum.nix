...
in {
  ...
  config = mkIf cfg.enable {
    home.configFile = {
      ...
      "Dracula-kvantum" = {
        recursive = true;
        source = "${pkgs.dracula-qt5-theme}/share/themes/Dracula/kde/kvantum/Dracula";
        target = "Kvantum/Dracula";
      };
      "Dracula-Solid-kvantum" = {
        recursive = true;
        source = "${pkgs.dracula-qt5-theme}/share/themes/Dracula/kde/kvantum/Dracula-Solid";
        target = "Kvantum/Dracula-Solid";
      };
      "Dracula-purple-kvantum" = {
        recursive = true;
        source = "${pkgs.dracula-qt5-theme}/share/themes/Dracula/kde/kvantum/Dracula-purple";
        target = "Kvantum/Dracula-purple";
      };
      "Dracula-purple-solid-kvantum" = {
        recursive = true;
        source = "${pkgs.dracula-qt5-theme}/share/themes/Dracula/kde/kvantum/Dracula-purple-solid";
